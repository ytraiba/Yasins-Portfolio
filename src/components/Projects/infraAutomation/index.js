    ...
    <div className="project-container" >
      ...
      <div className="project-description" data-aos="fade-right">
        ...
        <p>
          ...
          Playwright and PySimpleGui, I was able to create an application that downloads the nessesary PDF's, searchs
          for keywords in the PDFs, and sends an update on which documents are relevant to the user's email. 
          <br/>
          <br/>
          All of the scripts are executed in an asynchronous manner, allowing for the user to download PDFs from multuple websites
          at once. The graphical user interface allows non-techinal users to execute the scripts without having to use the command line.
